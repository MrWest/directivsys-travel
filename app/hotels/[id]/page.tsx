    ...
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <div className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute bottom-8 left-0 right-0 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <Link href="/hotels" className="text-slate-400 hover:text-slate-700 text-sm mb-3 block">← Back to Hotels</Link>
          <div className="flex items-end justify-between">
            <div>
              <div className="text-sky-600 text-lg mb-1">{'★'.repeat(hotel.stars)}</div>
              <h1 className="text-4xl font-bold text-slate-700">{hotel.name}</h1>
              <p className="text-slate-600 mt-1">📍 {hotel.location}</p>
            </div>
            <div className="text-right">
              <div className="text-3xl font-bold text-sky-600">${hotel.roomTypes[0].pricePerNight}</div>
